<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div>
                	<?php echo do_shortcode('[contact-form-7 id="190" title="Форма обратной связи"]'); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('instagram-link', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="<?php the_field('facebook-link', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="<?php the_field('youtube-link', 2); ?>" class="footer__social-item" target="_blank">
